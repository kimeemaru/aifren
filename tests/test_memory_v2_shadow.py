...
class ShadowServiceIsolationTests(unittest.TestCase):
    def service(self, shadow=None):
        return AssistantService(object(), _Memory(), _Conversation(), object(), {}, "", _Tts(), response_generator=lambda *_args: "unchanged reply", memory_v2_shadow=shadow, memory_authority="v1")
