...
from aifren.llm.unavailable import MODEL_CONFIGURATION_MESSAGE, UnavailableLLM
...
def create_llm():
    ...
    if settings["mode"] == "local":
        ...
        try:
            from aifren.runtime.config import LOCAL_LLM_CONTEXT_CHAR_BUDGET, LOCAL_LLM_CONTEXT_SIZE, CONTEXT_OPERATING_TARGET_TOKENS
