...
from aifren.context.companion_context import CompanionContextContribution, CompanionContextRequest
from aifren.conversation.temporal_context import parse_conversation_timestamp
...
class RecentPulseBuilder:
    ...
    def build(self, request: CompanionContextRequest) -> RecentPulseResult:
        ...
        for thread in repository.list_open_threads(request.character_id, limit=12,
            ...
            from aifren.memory_v2_store.open_thread_contract import normalize_open_thread_value
            try:
