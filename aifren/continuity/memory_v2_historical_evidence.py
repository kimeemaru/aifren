...
from aifren.character.character_registry import CharacterRegistry, CharacterRegistryError, REGISTRY_RELATIVE_PATH
...
def _source_class(record: Mapping[str, object]) -> tuple[str, bool] | None:
    ...
    if keys == _SCENE_UI_KEYS:
        from aifren.state.scene_ui_event import valid_scene_ui_origin
