...
from aifren.memory_v2_store import (EmbeddingLifecycle, MemoryV2Store,
                             MemoryV2Repository,
                             ActiveStateProposal,
...
from aifren.continuity.memory_v2_canonical_evidence import (
    CanonicalEvidenceDecision,
    CanonicalUserEvidence,
    resolve_canonical_user_evidence,
)
from aifren.continuity.memory_v2_telemetry import record_dual_read
...
from aifren.memory_v2_store.durable_contract import (
    DURABLE_ASSERTION_SCOPE,
    DURABLE_CORE_FACT,
)
from aifren.memory_v2_store.identity_name import (
...
class MemoryV2ShadowWriter:
        ...
        with ExitStack() as setup:
            ...
            if registry_path.exists():
                ...
                if selected.storage_layout == "local":
                    ...
                    from aifren.runtime.development_staged_runtime import development_staged_database_path
    ...
    def observe_governed_companion_action(
        ...
        *,
        ...
        try:
            from aifren.state.companion_action import CompanionActionPlan, semantic_action_evidence
    ...
    def _favorite_color_v1_predecessor(self) -> dict[str, Any] | None:
        ...
        if self.storage_layout == "local":
            return None
        try:
            from aifren.continuity.durable_fact_curation import extract_v1_favorite_color_memory
    ...
    def observe_canonical_user_continuity(
        ...
        *,
        ...
        try:
            ...
            from aifren.state.current_continuity import extract_current_continuity, find_exact_scenario_scope
