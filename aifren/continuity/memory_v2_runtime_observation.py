...
from aifren.continuity.memory_v2_canonical_evidence import LoadedCanonicalArchive, ORDINARY_USER_KEYS
from aifren.memory_v2_store.store import parse_timestamp_us, utc_now_us
...
class CanonicalObservationRecovery:
    ...
    def maintain_embeddings(self, provider):
        ...
        from aifren.memory_v2_store.embeddings import EmbeddingLifecycle
    ...
    def _state_replay_guard(self, consumer, message, index, archive, scope):
        ...
        """
        from aifren.continuity.memory_v2_shadow_writer import _CURRENT_CONTINUITY_NAMESPACE, _ACTIVE_HEADWEAR_NAMESPACE
    ...
    def _continuity_disposition(self, message, scope):
        ...
        from aifren.state.current_continuity import extract_current_continuity, extract_active_state_proposal
