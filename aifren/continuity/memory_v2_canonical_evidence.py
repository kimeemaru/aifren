...
from aifren.conversation.truth_scope import coherent_exchange_scope, parse_canonical_truth_scope
from aifren.continuity.durable_fact_curation import DurableFactProposal, extract_durable_fact_proposal
from aifren.continuity.memory_v2_episode_compaction import canonical_record_id
from aifren.memory_v2_store.identity_name import IdentityNameAssertion, extract_identity_name_assertion
...
class LoadedCanonicalArchive:
    ...
    @classmethod
    def load(cls, path):
        from aifren.conversation.persistence import load_json
