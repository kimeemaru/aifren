...
from aifren.llm.output_canonicalization import (
...
class AssistantService:
    ...
    def __init__(
        ...
        from aifren.runtime.config import RECENT_PULSE_ENABLED
        ...
        if transient_impulse_store is not None:
            from aifren.context.transient_impulses import TransientImpulseStore
        ...
        from aifren.runtime.model_settings import explicit_avatar_cues_enabled, companion_preferences
    ...
    def create_default(cls) -> "AssistantService":
        ...
        from aifren.assistant import initialize
        ...
        with ExitStack() as setup:
            ...
            if memory_authority == "v2":
                ...
                try:
                    from aifren.runtime.config import MEMORY_V2_REAL_TURN_SHADOW_ENABLED
            ...
            from aifren.runtime.config import (ACTIVE_STATE_CONTEXTUAL_SHADOW_ENABLED, ACTIVE_STATE_CONTEXTUAL_SHADOW_PROVIDER,
    ...
    def _admit_durable_context(self, user_message: str, *, report_failure: bool = False):
        ...
        if store is None or not self.character_id:
            ...
            return None
        try:
            from aifren.memory_v2_store import MemoryV2Repository, admit_durable_context
    ...
    def _admit_active_state_context(self, user_message: str):
        ...
        if store is None or not self.character_id:
            return None
        try:
            from aifren.memory_v2_store import MemoryV2Repository, admit_active_headwear_context
    ...
    def _admit_current_continuity_context(self, user_message: str):
        ...
        if store is None or not self.character_id:
            return None
        try:
            from aifren.conversation.temporal_context import derive_temporal_context_facts
    ...
    def _prepare_companion_memory_core(self, policy, requirement, authoritative):
        ...
        if (not getattr(self.llm, "companion_memory_realization", False)
            ...
            return None
        from aifren.continuity.companion_memory_realizer import CompanionMemoryRealizer
    ...
    def _apply_memory_authority_policy(
        ...
        *,
        ...
        if turn.authoritative_no_evidence and policy.requirement is None:
            from aifren.continuity.memory_v2_authority import render_authoritative_no_evidence
        ...
        if lookup_unavailable:
            from aifren.continuity.memory_v2_authority import MemoryV2AuthorityUnavailable
    ...
    def _response_policy(self, user_message: str) -> _ResponsePolicy:
        ...
        try:
            ...
            from aifren.state.current_continuity import recent_administrative_scene_clears
            ...
            if (preview.extraction is not None
                ...
                from aifren.dialogue.response_requirements import scene_clarification_requirement
    ...
    def _response_policy_for_scene_ui_event(self, event: object) -> _ResponsePolicy:
        ...
        try:
            ...
            from aifren.state.current_continuity import recent_administrative_scene_clears
            from aifren.memory_v2_store import MemoryV2Repository
            from aifren.state.scene_ui_event import scene_ui_response_requirement
    ...
    def _recent_policy_user_turns(self) -> tuple[object, ...]:
        ...
        from aifren.state.continuity_reference import (
    ...
    def _assemble_memory_answer_response(
        ...
        from aifren.continuity.memory_v2_answer_governance import assemble_memory_answer_dialogue
    ...
    def _validate_governed_response(
        ...
        if policy.temporal_facts is not None:
            from aifren.conversation.temporal_context import temporal_activity_duration_invented
        ...
        if policy.requirement is not None:
            from aifren.dialogue.response_requirements import validate_response_requirement
        ...
        if policy.memory_answer_requirement is not None:
            ...
            if policy.memory_realized_response is not None:
                from aifren.continuity.companion_memory_realizer import owned_reaction_valid
        ...
        if policy.action_decision_category is not None:
            from aifren.state.companion_action import action_narration_valid, unauthorized_action_narrated
    ...
    def _repair_governed_response(
        ...
        from aifren.state.capability_policy import capability_context_block, normalize_constrained_caption
        ...
        if policy.requirement is not None:
            from aifren.dialogue.response_requirements import repair_requirement_prompt
        ...
        if policy.memory_answer_requirement is not None:
            from aifren.continuity.memory_v2_answer_governance import memory_answer_repair_prompt
        ...
        if self._act_eligible(policy):
            from aifren.dialogue.act_presentation import parse_fresh_act_response
        ...
        if policy.effects is not None:
            from aifren.state.capability_policy import normalize_response_for_capabilities
    ...
    def _governed_fallback_response(self, policy: _ResponsePolicy) -> ParsedAssistantResponse:
        ...
        if policy.action_plan is not None:
            from aifren.state.companion_action import action_fallback_dialogue
    ...
    def interaction_policy(self, user_message: str = ""):
        ...
        if store is None or not self.character_id:
            return None
        try:
            from aifren.state.interaction_policy import classify_interaction_policy
            from aifren.memory_v2_store import MemoryV2Repository
    ...
    def _generate_sleep_reaction(self, decision, user_message: str):
        ...
        from aifren.state.interaction_policy import render_sleep_reaction, sleep_reaction_prompt
        ...
        if store is not None and self.character_id:
            try:
                from aifren.memory_v2_store import MemoryV2Repository
                from aifren.state.capability_policy import preview_capability_effects
    ...
    def _act_eligible(self, policy: _ResponsePolicy | None) -> bool:
        from aifren.dialogue.act_presentation import act_character_prompt
    ...
    def _ordinary_text_eligible(self, policy: _ResponsePolicy | None, *,
        ...
        if (self._response_generator is not None or self._memory_authority != "v2"
            ...
            return False
        from aifren.continuity.memory_query_decision import MemoryQueryDecision
        from aifren.memory_v2_store.scene_relation_contract import CapabilityEffects
        from aifren.dialogue.response_requirements import ResponseRequirement
        ...
        if requirement is not None and not (
            ...
            return False
        from aifren.continuity.memory_v2_answer_governance import MemoryAnswerRequirement
    ...
    def _response_character_prompt(self, *, ordinary_policy: _ResponsePolicy | None = None) -> str:
        ...
        if self.conversation_style == "natural":
            ...
            if local and eligible:
                ...
                from aifren.dialogue.conversation_style import natural_character_prompt
        ...
        if self._lean_ordinary_eligible(ordinary_policy):
            from aifren.dialogue.presentation_metadata import lean_ordinary_character_prompt
    ...
    def _context_prompt_parts(self, ordinary_policy, companion_context):
        from aifren.context.context_governor import ContextPlanItem, governor_enabled
    ...
    def _ordinary_companion_context(self, user_message, *, active_truth_scope=None,
        ...
        from aifren.conversation.temporal_context import clock_local_datetime
        from aifren.continuity.memory_query_decision import decide_memory_query
    ...
    def _stream_reply(
        ...
        from aifren.assistant import build_response_request
        ...
        from aifren.dialogue.act_presentation import ActPrefixStream
    ...
    def apply_companion_preferences(self, preferences: dict) -> None:
        ...
        if self.automatic_expressions and self._automatic_expression_worker is None:
            from aifren.dialogue.automatic_expression import AutomaticExpressionWorker
    ...
    def _dispatch_direct_speech_with_recovery(
        ...
        *,
        ...
        from aifren.tts.streaming import TtsSynthesisResourceManager
        ...
        try:
            ...
            try:
                ...
                def enqueue_speech(chunk: str, subtitle_source: str) -> None:
                    ...
                    with self._speech_generation_lock:
                        ...
                        if speech_queue is None:
                            from aifren.runtime.config import TTS_CHUNK_QUEUE_MAX
                            from aifren.tts.streaming import StreamingSpeechQueue
                ...
                if response_policy.memory_realization is not None:
                    from aifren.continuity.companion_memory_realizer import CompanionMemoryRealizer, CompanionMemoryResponse
                ...
                if policy_decision is not None and policy_decision.response_mode is not None:
                    ...
                    if not accepted and response_policy.memory_realized_response is not None:
                        from aifren.continuity.companion_memory_realizer import CompanionMemoryResponse
                    ...
                    if not accepted:
                        ...
                        from aifren.continuity.memory_v2_answer_governance import memory_answer_should_attempt_repair
                        repair_attempted = (
    ...
    def _mark_proactive_checkins_responded(self, canonical_user_message: object) -> None:
        ...
        try:
            from aifren.memory_v2_store.store import parse_timestamp_us
            from aifren.context.proactive_companion import mark_checkins_responded
    ...
    def proactive_eligibility(self, *, now_us: int | None = None, enabled: bool | None = None,
        ...
        try:
            ...
            from aifren.context.proactive_companion import evaluate_proactive_eligibility
            if now_us is None:
    ...
    def process_proactive_checkin(self, *, now_us: int | None = None, speak: bool = True) -> TurnResult:
        ...
        def record_attempt(outcome: str) -> None:
            ...
            try:
                from aifren.context.proactive_companion import record_proactive_attempt
        ...
        try:
            ...
            from aifren.conversation.temporal_context import clock_local_datetime
            from aifren.context.proactive_companion import record_displayed_checkin, render_proactive_reason
            ...
            if not accepted:
                ...
                if repaired is not None:
                    ...
                    from aifren.continuity.memory_v2_answer_governance import remove_unsupported_retrospective_sentences
                    projected = remove_unsupported_retrospective_sentences(
            ...
            from aifren.state.capability_policy import capability_requires_validation
            parsed = replace(
    ...
    def truth_scope_provenance(self) -> dict[str, str] | None:
        ...
        if store is None or not self.character_id:
            return None
        try:
            from aifren.conversation.truth_scope import canonical_truth_scope
            from aifren.memory_v2_store import MemoryV2Repository
            scope = MemoryV2Repository(store).active_truth_scope(str(self.character_id))
    ...
    def continuity_snapshot(self) -> dict[str, Any]:
        ...
        from aifren.state.current_continuity import USER_ACTIVITY_KEY
        from aifren.memory_v2_store import MemoryV2Repository
    ...
    def _complete_scene_control_record(self, result, payload, *, event_id, character_id):
        ...
        from aifren.state.scene_ui_event import load_scene_ui_control_record
        ...
        try:
            ...
            with store.transaction():
                ...
                if action == "clear_activity":
                    ...
                    from aifren.memory_v2_store import ActiveSceneSubjectRetirement, ActiveStateProposal
    ...
    def _general_memory_allowed(self, user_message: str, continuity_result: dict[str, Any]) -> bool:
        ...
        if store is None or not self.character_id:
            return True
        try:
            from aifren.state.current_continuity import game_event_is_contextual
            from aifren.memory_v2_store import MemoryV2Repository
            repository = MemoryV2Repository(store)
