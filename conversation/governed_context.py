...
from conversation.truth_scope import active_scope_from_provenance, filter_scope_compatible_history
from memory_v2_episode_compaction import canonical_record_id
from memory_v2_source_containment import RECENT_CONVERSATION_BOUNDARY
