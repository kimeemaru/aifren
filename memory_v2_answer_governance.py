...
from memory_query_decision import MemoryQueryDecision, MemoryQuerySlot, decide_memory_query
from memory_v2_evidence_sufficiency import admit_requested_slots
...
from memory_v2_source_containment import recent_only_anchor_sources
...
def _speech_act(value: object) -> str:
    ...
    if not text:
        return "other"
    from user_assertion_semantics import extract_embedded_self_assertion
