...
from memory_v2_store import ActiveStateProposal, ActiveStateProposalUpdate, MemoryV2Repository
from memory_v2_store.scene_relation_contract import CapabilityEffects, SceneRelationProposal
from presentation_metadata import ParsedAssistantResponse
